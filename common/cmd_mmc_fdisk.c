...
#define		SYSTEM_PART_SIZE		(unsigned long long)(300*1024*1024)
#if 1 //esshin 20160421 emmc 128GB(KLMDG8JENB) or over emmc 8GB ---(
#define		USER_DATA_PART_SIZE_IN_128GB_MMC  (unsigned long long)((unsigned long long)118350*(unsigned long long)1024*(unsigned long long)1024) // format fail ?
//#define		USER_DATA_PART_SIZE_IN_128GB_MMC  (unsigned long long)((unsigned long long)8100*(unsigned long long)1024*(unsigned long long)1024) // format ok
#define		USER_DATA_PART_SIZE_IN_64GB_MMC  (unsigned long long)((unsigned long long)61000*(unsigned long long)1024*(unsigned long long)1024)
#define		USER_DATA_PART_SIZE_IN_32GB_MMC  (unsigned long long)((unsigned long long)29000*(unsigned long long)1024*(unsigned long long)1024)
#define		USER_DATA_PART_SIZE_IN_16GB_MMC  (unsigned long long)((unsigned long long)13000*(unsigned long long)1024*(unsigned long long)1024)
#endif // ---)
#define		USER_DATA_PART_SIZE_IN_8GB_MMC  (unsigned long long)((unsigned long long)6505*(unsigned long long)1024*(unsigned long long)1024)
#define		USER_DATA_PART_SIZE_IN_4GB_MMC  (unsigned long long)((unsigned long long)2791*(unsigned long long)1024*(unsigned long long)1024)
#define		CACHE_PART_SIZE			(unsigned long long)(200*1024*1024)
...
// 반드시 Unit단위로 먼저 계산한다.
	...
	if (flag) {
		...
		printf("system input : %llu\n", (unsigned long long)simple_strtoul(argv[3], NULL, 0)*1024*1024);
	} else {
		block_offset = calc_unit(SYSTEM_PART_SIZE, sdInfo);
		printf("system default : %llu\n", SYSTEM_PART_SIZE);
	}
...
///////////////////////////////////////////////////////////	
	...
	if (flag) {
		...
		printf("user input : %llu\n", (unsigned long long)simple_strtoul(argv[4], NULL, 0)*1024*1024);
	} else {
#if 1 //esshin 20160420 emmc 128GB(KLMDG8JENB) ---(
		if(total_block_count >= 128000000) {
                    block_offset = calc_unit(USER_DATA_PART_SIZE_IN_128GB_MMC, sdInfo);
                    printf("user default : %llu\n", USER_DATA_PART_SIZE_IN_128GB_MMC);
		} else if(total_block_count >= 64000000) {
					block_offset = calc_unit(USER_DATA_PART_SIZE_IN_64GB_MMC, sdInfo);
					printf("user default : %llu\n", USER_DATA_PART_SIZE_IN_64GB_MMC);
		} else if(total_block_count >= 32000000) {
					block_offset = calc_unit(USER_DATA_PART_SIZE_IN_32GB_MMC, sdInfo);
					printf("user default : %llu\n", USER_DATA_PART_SIZE_IN_32GB_MMC);
		} else if(total_block_count >= 16000000) {
					block_offset = calc_unit(USER_DATA_PART_SIZE_IN_16GB_MMC, sdInfo);
					printf("user default : %llu\n", USER_DATA_PART_SIZE_IN_16GB_MMC);
		} else 
#endif // ---)
		if(total_block_count >= 8000000) {
                    block_offset = calc_unit(USER_DATA_PART_SIZE_IN_8GB_MMC, sdInfo);
                    printf("user default : %llu\n", USER_DATA_PART_SIZE_IN_8GB_MMC);
		} else {
                    block_offset = calc_unit(USER_DATA_PART_SIZE_IN_4GB_MMC, sdInfo);
                    printf("user default : %llu\n", USER_DATA_PART_SIZE_IN_4GB_MMC);
		}
	}
...
///////////////////////////////////////////////////////////	
	...
	if (flag) {
		...
		printf("cache input : %llu\n", (unsigned long long)simple_strtoul(argv[5], NULL, 0)*1024*1024);
	} else {
		block_offset = calc_unit(CACHE_PART_SIZE, sdInfo);
		printf("cache default : %llu\n", CACHE_PART_SIZE);
	}
