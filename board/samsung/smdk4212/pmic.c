...
void pmic_s5m8767_init()
{
	...
	//printf("%s\n",__func__);
	//buck1
	IIC0_EWrite(S5M8767_ADDR, 0x32, 0xD8);
	IIC0_EWrite(S5M8767_ADDR, 0x34, 0xFA);
	IIC0_EWrite(S5M8767_ADDR, 0x3D, 0xFA);
	IIC0_EWrite(S5M8767_ADDR, 0x46, 0xFA);
	...
	//Buck5
	IIC0_EWrite(S5M8767_ADDR, 0x4F, 0xD8);
	//Buxk6
	IIC0_EWrite(S5M8767_ADDR, 0x54, 0x18);
	
	//reset all LDOs
	IIC0_EWrite(S5M8767_ADDR, 0x5c, 0xc8);
	IIC0_EWrite(S5M8767_ADDR, 0x5d, 0xD0);
	IIC0_EWrite(S5M8767_ADDR, 0x64, 0xC8);
	IIC0_EWrite(S5M8767_ADDR, 0x65, 0xC8);
	IIC0_EWrite(S5M8767_ADDR, 0x66, 0xC8);
	IIC0_EWrite(S5M8767_ADDR, 0x6d, 0xC8);

	IIC0_EWrite(S5M8767_ADDR, 0x61, 0xd4);
	IIC0_EWrite(S5M8767_ADDR, 0x62, 0xd4);
	IIC0_EWrite(S5M8767_ADDR, 0x63, 0xd4);
	IIC0_EWrite(S5M8767_ADDR, 0x67, 0x2c);
	IIC0_EWrite(S5M8767_ADDR, 0x68, 0xd4);
	IIC0_EWrite(S5M8767_ADDR, 0x69, 0xd4);
	IIC0_EWrite(S5M8767_ADDR, 0x69, 0xd4);
	IIC0_EWrite(S5M8767_ADDR, 0x6a, 0xec);
	IIC0_EWrite(S5M8767_ADDR, 0x6b, 0x14); // 0xd4 -> 0x14
	IIC0_EWrite(S5M8767_ADDR, 0x6c, 0xd4);
	IIC0_EWrite(S5M8767_ADDR, 0x6e, 0xd4);
	IIC0_EWrite(S5M8767_ADDR, 0x6f, 0xe8);
	IIC0_EWrite(S5M8767_ADDR, 0x70, 0x28);
	IIC0_EWrite(S5M8767_ADDR, 0x71, 0x2c);
	IIC0_EWrite(S5M8767_ADDR, 0x72, 0x2c);
	IIC0_EWrite(S5M8767_ADDR, 0x73, 0x2c);
	IIC0_EWrite(S5M8767_ADDR, 0x74, 0x32);
	IIC0_EWrite(S5M8767_ADDR, 0x75, 0x28);
	IIC0_EWrite(S5M8767_ADDR, 0x75, 0x28);
	IIC0_EWrite(S5M8767_ADDR, 0x76, 0x2c);
	IIC0_EWrite(S5M8767_ADDR, 0x77, 0x08);
	IIC0_EWrite(S5M8767_ADDR, 0x78, 0x14);
	IIC0_EWrite(S5M8767_ADDR, 0x79, 0x14);
	IIC0_EWrite(S5M8767_ADDR, 0x7a, 0x14);
...
//	} else if((0 <= read_data) && (read_data <= 0x5)) {
	} else if((0 <= read_data) && (read_data <= 0x15)) {	
		pmic_s5m8767_init();
	} else {
