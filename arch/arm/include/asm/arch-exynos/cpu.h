...
#include "cpu_exynos5250_evt1.h"
#else
#include "cpu_exynos5250_evt0.h"
#endif
#else
...
#define S5PV310_TMU_BASE	0x100C0000
#define S5PV310_FIMD_BASE	0x11C00000
...
#define LCDBLK_CFG_REG	__REG(S5PV310_SYSREG_BASE+LCDBLK_CFG_OFFSET)
...
#define ARM_CORE2_CONFIGURATION_OFFSET			0x2100
#define ARM_CORE2_STATUS_OFFSET					0x2104
#define ARM_CORE2_OPTION_OFFSET					0x2108

#define ARM_CORE3_CONFIGURATION_OFFSET			0x2180
#define ARM_CORE3_STATUS_OFFSET					0x2184
#define ARM_CORE3_OPTION_OFFSET					0x2188
...
#define LCD0_CONFIGURATION_OFFSET		0x3C88
...
#define ARM_CORE1_CONFIGURATION_REG			  __REG(S5PV310_POWER_BASE+ARM_CORE1_CONFIGURATION_OFFSET)
#define ARM_CORE1_STATUS_REG			  __REG(S5PV310_POWER_BASE+ARM_CORE1_STATUS_OFFSET)
#define ARM_CORE1_OPTION_REG			  __REG(S5PV310_POWER_BASE+ARM_CORE1_OPTION_OFFSET)


#define ARM_CORE2_CONFIGURATION_REG			  __REG(S5PV310_POWER_BASE+ARM_CORE2_CONFIGURATION_OFFSET)
#define ARM_CORE2_STATUS_REG			  __REG(S5PV310_POWER_BASE+ARM_CORE2_STATUS_OFFSET)
#define ARM_CORE2_OPTION_REG			  __REG(S5PV310_POWER_BASE+ARM_CORE2_OPTION_OFFSET)

#define ARM_CORE3_CONFIGURATION_REG			  __REG(S5PV310_POWER_BASE+ARM_CORE3_CONFIGURATION_OFFSET)
#define ARM_CORE3_STATUS_REG			  __REG(S5PV310_POWER_BASE+ARM_CORE3_STATUS_OFFSET)
#define ARM_CORE3_OPTION_REG			  __REG(S5PV310_POWER_BASE+ARM_CORE3_OPTION_OFFSET)

#define PS_HOLD_CONTROL_REG			  __REG(S5PV310_POWER_BASE+PS_HOLD_CONTROL_OFFSET)
#define XXTI_CONFIGURATION_REG		__REG(S5PV310_POWER_BASE+XXTI_CONFIGURATION_OFFSET)
#define XXTI_STATUS_REG		__REG(S5PV310_POWER_BASE+XXTI_STATUS_OFFSET)

#define CAM_CONFIGURATION_REG 	__REG(S5PV310_POWER_BASE+CAM_CONFIGURATION_OFFSET)
#define TV_CONFIGURATION_REG 	__REG(S5PV310_POWER_BASE+TV_CONFIGURATION_OFFSET)
#define MFC_CONFIGURATION_REG 	__REG(S5PV310_POWER_BASE+MFC_CONFIGURATION_OFFSET)
#define MFC_STATUS_REG			__REG(S5PV310_POWER_BASE+MFC_STATUS_OFFSET)

#define G3D_CONFIGURATION_REG __REG(S5PV310_POWER_BASE+G3D_CONFIGURATION_OFFSET)
#define G3D_STATUS_REG __REG(S5PV310_POWER_BASE+G3D_STATUS_OFFSET)

#define LCD0_CONFIGURATION_REG __REG(S5PV310_POWER_BASE+LCD0_CONFIGURATION_OFFSET)
#define ISP_CONFIGURATION_REG __REG(S5PV310_POWER_BASE+ISP_CONFIGURATION_OFFSET)
#define MAUDIO_CONFIGURATION_REG __REG(S5PV310_POWER_BASE+MAUDIO_CONFIGURATION_OFFSET)
#define GPS_CONFIGURATION_REG __REG(S5PV310_POWER_BASE+GPS_CONFIGURATION_OFFSET)
#define GPS_ALIVE_CONFIGURATION_REG __REG(S5PV310_POWER_BASE+GPS_ALIVE_CONFIGURATION_OFFSET)
 ...
 * ROOTKEY
 */
#define ROOTKEY_BASE			0x10100000
...
#define TZPC_R0SIZE_OFFSET		0x0
#define TZPC_DECPROT0STAT_OFFSET	0x800
#define TZPC_DECPROT0SET_OFFSET		0x804
#define TZPC_DECPROT0CLR_OFFSET		0x808
#define TZPC_DECPROT1STAT_OFFSET	0x80C
#define TZPC_DECPROT1SET_OFFSET		0x810
#define TZPC_DECPROT1CLR_OFFSET		0x814
#define TZPC_DECPROT2STAT_OFFSET	0x818
#define TZPC_DECPROT2SET_OFFSET		0x81C
#define TZPC_DECPROT2CLR_OFFSET		0x820
#define TZPC_DECPROT3STAT_OFFSET	0x824
#define TZPC_DECPROT3SET_OFFSET		0x828
#define TZPC_DECPROT3CLR_OFFSET		0x82C

/*
 * TZASC
 */
#define TZASC_LR_BASE			0x10700000
#define TZASC_LW_BASE			0x10710000
#define TZASC_RR_BASE			0x10720000
#define TZASC_RW_BASE			0x10730000

#define TZASC_REGION0ATTR_OFFSET	0x108
#define TZASC_REGION3ATTR_OFFSET	0x138
#define TZASC_REGION3SETUPLOW_OFFSET	0x130

/*
 * GIC
 */
#define GIC_CPU_BASE			0x10480000
#define GIC_DIST_BASE			0x10490000

#define GIC_ICCICR_CPU_OFFSET		0x0
#define GIC_ICCPMR_CPU_OFFSET		0x4

#define GIC_ICDISR0_CPU_OFFSET		0x80
#define GIC_ICDISR1_OFFSET		0x84
#define GIC_ICDISR2_OFFSET		0x88
#define GIC_ICDISR3_OFFSET		0x8C
#define GIC_ICDISR4_OFFSET		0x90
...
#define SCU_SNSAC_OFFSET		0x54

/*
 * L2 Cache
 */
#define L2CC_BASE			0x10502000

#define L2CC_CTRL_OFFSET		0x100
#define L2CC_AUX_CTRL_OFFSET		0x104
#define L2CC_TAG_RAM_CTRL_OFFSET	0x108
#define L2CC_DATA_RAM_CTRL_OFFSET	0x10C
#define L2CC_CACHE_SYNC_OFFSET		0x730
#define L2CC_INV_WAY_OFFSET		0x77C
#define L2CC_DEBUG_CTRL_OFFSET		0xF40
#define L2CC_PREFETCH_CTRL_OFFSET	0xF60
#define L2CC_POWER_CTRL_OFFSET		0xF80
...
#define TRIMINFO_OFFSET 0x0
#define TRIMINFO_CONTROL_OFFSET 0x14
#define TMU_CONTROL_OFFSET 0x20
#define CURRENT_TEMP_OFFSET 0x40
#define THRESHOLD_TEMP_RISE_OFFSET 0x50
#define THRESHOLD_TEMP_FALL_OFFSET 0x54
#define INTEN_OFFSET 0x70
#define INTCLEAR_OFFSET 0x78
...
#define TRIMINFO_REG			  __REG(S5PV310_TMU_BASE+TRIMINFO_OFFSET)
#define TRIMINFO_CONTROL_REG			  __REG(S5PV310_TMU_BASE+TRIMINFO_CONTROL_OFFSET)
#define CURRENT_TEMP_REG			  __REG(S5PV310_TMU_BASE+CURRENT_TEMP_OFFSET)
#define TMU_CONTROL_REG			  __REG(S5PV310_TMU_BASE+TMU_CONTROL_OFFSET)
#define THRESHOLD_TEMP_RISE_REG			  __REG(S5PV310_TMU_BASE+THRESHOLD_TEMP_RISE_OFFSET)
#define THRESHOLD_TEMP_FALL_REG			  __REG(S5PV310_TMU_BASE+THRESHOLD_TEMP_FALL_OFFSET)
#define INTCLEAR_REG			  __REG(S5PV310_TMU_BASE+INTCLEAR_OFFSET)
#define INTEN_REG			  __REG(S5PV310_TMU_BASE+INTEN_OFFSET)
